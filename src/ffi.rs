...
extern {
    ...
    pub fn BluetoothAdapter_startDiscovery() -> c_void;
    pub fn BluetoothAdapter_stopDiscovery() -> c_void;
    ...
    //pub fn BluetoothGattCharacteristic_getValue(address: *const c_char, id: c_int) -> *const c_uchar;
    //pub fn BluetoothGattCharacteristic_setValue(address: *const c_char, id: c_int, values: *const c_uchar) -> c_void;
